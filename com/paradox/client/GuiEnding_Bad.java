...
public class GuiEnding_Bad extends GuiScreen{
	...
	public static final ResourceLocation l0 = new ResourceLocation("paradoxmod","textures/ending/bad/sky_view_frame_0.png");
	public static final ResourceLocation l1 = new ResourceLocation("paradoxmod","textures/ending/bad/sky_view_frame_1.png");
	public static final ResourceLocation l2 = new ResourceLocation("paradoxmod","textures/ending/bad/break_frame_0.png");
	public static final ResourceLocation l3 = new ResourceLocation("paradoxmod","textures/ending/bad/break_frame_1.png");
	public static final ResourceLocation l4 = new ResourceLocation("paradoxmod","textures/ending/bad/fade_frame_0.png");
	public static final ResourceLocation l5 = new ResourceLocation("paradoxmod","textures/ending/bad/fade_frame_1.png");
	public static final ResourceLocation l6 = new ResourceLocation("paradoxmod","textures/ending/bad/explode_frame_0.png");
	public static final ResourceLocation l7 = new ResourceLocation("paradoxmod","textures/ending/bad/explode_frame_1.png");
	public static final ResourceLocation l8 = new ResourceLocation("paradoxmod","textures/ending/bad/explode_frame_2.png");
	public static final ResourceLocation l9 = new ResourceLocation("paradoxmod","textures/ending/bad/explode_frame_3.png");
	public static final ResourceLocation l10 = new ResourceLocation("paradoxmod","textures/ending/bad/explode_frame_4.png");
	public static final ResourceLocation l11 = new ResourceLocation("paradoxmod","textures/ending/bad/explode_frame_5.png");
	public static final ResourceLocation l12 = new ResourceLocation("paradoxmod","textures/ending/bad/explode_frame_6.png");
	public static final ResourceLocation l13 = new ResourceLocation("paradoxmod","textures/ending/bad/explode_frame_7.png");

	public GuiEnding_Bad()
	{
		super();
		...
		Minecraft.getMinecraft().theWorld.playSound(Minecraft.getMinecraft().thePlayer.posX,
				...
				"paradoxmod:sound.badending", 100, 1, true);
	}
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_)
    {
    	...
    	if(this.ticksPassed > 780 && this.ticksPassed <= 900)
    	{
    		...
    		Minecraft.getMinecraft().theWorld.playSound(Minecraft.getMinecraft().thePlayer.posX+MathUtils.randomDouble(Minecraft.getMinecraft().theWorld.rand),
    				...
    				"random.explode", 0.01F, Minecraft.getMinecraft().theWorld.rand.nextFloat()*2, true);
    	}
    	if(this.ticksPassed > 900 && this.ticksPassed <= 1100)
    	{
    		...
    		Minecraft.getMinecraft().theWorld.playSound(Minecraft.getMinecraft().thePlayer.posX+MathUtils.randomDouble(Minecraft.getMinecraft().theWorld.rand),
    				Minecraft.getMinecraft().thePlayer.posY+MathUtils.randomDouble(Minecraft.getMinecraft().theWorld.rand),
    				Minecraft.getMinecraft().thePlayer.posZ+MathUtils.randomDouble(Minecraft.getMinecraft().theWorld.rand),
    				"random.explode", 0.05F, Minecraft.getMinecraft().theWorld.rand.nextFloat()*2, true);
    	}
    	if(this.ticksPassed > 1100 && this.ticksPassed <= 1400)
    	{
    		...
    		Minecraft.getMinecraft().theWorld.playSound(Minecraft.getMinecraft().thePlayer.posX+MathUtils.randomDouble(Minecraft.getMinecraft().theWorld.rand),
    				Minecraft.getMinecraft().thePlayer.posY+MathUtils.randomDouble(Minecraft.getMinecraft().theWorld.rand),
    				Minecraft.getMinecraft().thePlayer.posZ+MathUtils.randomDouble(Minecraft.getMinecraft().theWorld.rand),
    				"random.explode", 0.1F, Minecraft.getMinecraft().theWorld.rand.nextFloat()*2, true);
    	}
    	if(this.ticksPassed > 1400 && this.ticksPassed <= 1600)
    	{
    		...
    		Minecraft.getMinecraft().theWorld.playSound(Minecraft.getMinecraft().thePlayer.posX+MathUtils.randomDouble(Minecraft.getMinecraft().theWorld.rand),
    				Minecraft.getMinecraft().thePlayer.posY+MathUtils.randomDouble(Minecraft.getMinecraft().theWorld.rand),
    				Minecraft.getMinecraft().thePlayer.posZ+MathUtils.randomDouble(Minecraft.getMinecraft().theWorld.rand),
    				"random.explode", 0.2F, Minecraft.getMinecraft().theWorld.rand.nextFloat()*2, true);
    	}
    	...
    	GL11.glPushMatrix();
    		GL11.glScalef(2, 2, 2);
    		this.fontRendererObj.drawString("You didn't make it...", k/2, (this.height-(int) ticksPassed)/2, 0xffffff, false);
    		this.fontRendererObj.drawString("...you've tried.", k/2, (this.height-(int) ticksPassed)/2+10, 0xffffff, false);
    	GL11.glPopMatrix();
    	...
    	if(this.ticksPassed > 2000)
    	{
	    	GL11.glPushMatrix();
				GL11.glScalef(3, 3, 3);
				this.fontRendererObj.drawString("Game Over.", k/3, l, 0xff0000, true);
			GL11.glPopMatrix();
    	}
    	//1200 frames;
    }
