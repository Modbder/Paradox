...
public class RenderTilePotentiaGen extends TileEntitySpecialRenderer{
			...
			double p_147500_4_, double p_147500_6_, float p_147500_8_)
	{
		...
		RenderHelper.disableStandardItemLighting();
			...
			for(int i = 0; i < 4; ++i)
			{
				...
				TilePotentiaGenerator gen = (TilePotentiaGenerator) p_147500_1_;
				
				ParadoxClient.drawAspectContainer(gen, Aspect.ENERGY);
