package com.paradox.common.inventory;
...
public class InventoryMRUGenerator extends Container{
	
    private IInventory inv;
    public InventoryMRUGenerator(InventoryPlayer par1InventoryPlayer, TileEntity par2)
    {
        this.inv = (IInventory) par2;
        int i;
        this.addSlotToContainer(new SlotBoundEssence((IInventory) par2, 0, 26, 23));
        for (i = 0; i < 3; ++i)
        {
            for (int j = 0; j < 9; ++j)
            {
