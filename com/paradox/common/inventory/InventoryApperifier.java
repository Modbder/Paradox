...
public class InventoryApperifier extends Container{
	
    private IInventory inv;
    public InventoryApperifier(InventoryPlayer par1InventoryPlayer, TileEntity par2)
    {
        this.inv = (IInventory) par2;
        int i;
        this.addSlotToContainer(new Slot((IInventory) par2, 0, 82, 23));
        for (i = 0; i < 3; ++i)
        {
            for (int j = 0; j < 9; ++j)
            {
